...
void deleteKthPosition(node *&head, int position)
{
    ...
    node *nodetoFree = traveller->next;
...
int main()
{
    ...
    while (1)
    {
        printf("\n1. Insert new item. 2. Delete item. 3. Search item. \n4. Insert Last. \n5. Print. 6.Delete Last \
        \n7.Delete First 8.Insert After 9.Print Linked List in Reverse way. \n\
        \n10.Sum 11.Make the linked list reverse \n\
       \n13. Delete kth position\n\
        \n12.Exit\n--------------------------------------------------------------------------------------\n");
        ...
        else if (ch == 13)
        {
            ...
            int position;
            cin >> position;
            deleteKthPosition(head, position);
        }
        else if (ch == 12)
            return 0;
        else
